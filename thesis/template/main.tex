...
%dokumentu wystarczy usunąć poniąszą linię
...
\author{Jan Nowak}
\supervisor{dr hab. inż. Imię Nazwisko Prof. PWr}
...
%bieążcy rok, to polecenie pozwala wstawić dowolny rok

%poniżej definiuje sie kierunek i specjalność
\field{Informatyczne Systemy Automatyki (ISA)}
\specialisation{Komputerowe Systemy Sterowania (IKA)}

\keywords{Pierwsze słowo kluczowe, kolejne słowo kluczowe, łącznie 3-6 słów kluczowych
}
